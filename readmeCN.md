...
如果你不想配置 Python 环境，可以直接下载打包好的独立运行程序：

1. 前往项目的 [Releases 页面](https://github.com/YingLuoNou/EInk-Image-Toolkit/releases/latest)。
2. 在 **Assets** 列表中下载最新的 `EInk-Image-Toolkit.exe`。
3. 双击即可直接运行，无需安装任何依赖！

> **注意**：由于是单文件打包的 exe，首次启动解压资源时可能需要几秒钟，请耐心等待。如果遇到杀毒软件误报，请允许运行或添加信任。
...
```Bash
git clone https://github.com/yourusername/EInk-Image-Toolkit.git
